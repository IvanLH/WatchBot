...
<html lang="es">
	...
	<body>
		...
		<div class="menu-opciones">
			...
			<a class="menu__link active" href="emergencias.php">EMERGENCIAS</a>
		...
		<div class="seccion seccion-experiencia">
			<div class="normateca">
				<a class="emergencias_filtro" name="todas" href="emergencias.php">TODAS</a>
				<a class="emergencias_filtro active" name="pendientes" href="pendientes.php">PENDIENTES</a>
				<a class="emergencias_filtro" name="concluidas" href="concluidas.php">CONCLUIDAS</a>
			</div>
