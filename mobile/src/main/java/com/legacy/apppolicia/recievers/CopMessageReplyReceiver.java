...
import com.legacy.apppolicia.services.BackgroundPostService;
import com.legacy.apppolicia.services.CopMessagingService;

/**
 * A receiver that gets called when a reply is sent to a given conversationId
 */
public class CopMessageReplyReceiver extends BroadcastReceiver {

    private static final String TAG = CopMessageReplyReceiver.class.getSimpleName();
    ...
    private CharSequence getMessageText(Intent intent) {
        ...
        if (remoteInput != null) {
            return remoteInput.getCharSequence(CopMessagingService.EXTRA_VOICE_REPLY);
        }
        return null;
    }
}
